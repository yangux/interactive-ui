...
let all_circles = [];
for (let i = 0; i < 10; i++) {
  let random_x = randomNumber(radius, window.innerWidth - radius);
  let random_y = randomNumber(radius, window.innerHeight - radius);
